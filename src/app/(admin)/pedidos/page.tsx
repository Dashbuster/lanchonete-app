...
const mockOrders: OrderType[] = [
  ...
  },
  {
    ...
    paymentMethod: "PIX",
    items: [
      { id: "i10", product: { name: "Acai 300ml", image: null }, quantity: 1, unitPrice: 22.0, observations: "Com granola e banana", addons: [{ name: "Leite em po", price: 2.0 }, { name: "Pacoca", price: 2.0 }] },
